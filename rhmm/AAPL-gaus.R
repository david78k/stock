...
chartSeries(testset[1:rows, 1], name = 'Actual', TA = "addTA(testset[1:rows, 7], on = 1, col='yellow', legend = \"Predicted\")") # 
#chartSeries(testset[2:rows, 1], name = 'Actual', TA = "addTA(testset[2:rows, 7], on = 1, col='yellow', legend = \"Predicted\")") # 
