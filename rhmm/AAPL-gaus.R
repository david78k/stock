...
chartSeries(testset[, 1], TA = "addTA(testset[, 7], on = 1, col="blue", legend = \"Predicted\")"), # 
#chartSeries(testset[, 1], name = 'Actual', TA = "addTA(testset[, 7], on = 1, col=7, legend = \"Predicted\")"), # yellow
