...
#plot(as.numeric(goog1[,2]), xlab = "DAY", ylab = "STOCK VALUE ($)", lty = 1, col="blue")
plot(goog1[,2], xlab = "DAY", ylab = "STOCK VALUE ($)", type = "l", col="blue")

# close value
#lines(as.numeric(goog1[,5]), col="red")
#lines(goog1[,5], col="red")
lines(goog1[,5], type = "l", col="red")
#lines(goog1[,2], type = "l", col="red")
#lines(goog1[,3], type = "l", col="green")
