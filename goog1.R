...
data <- read.csv("http://www.google.com/finance/historical?q=goog1&startdate=Aug+19%2C+2004&enddate=Mar+1%2C+2013&output=csv ", sep=",", header=1)
...
write.csv(goog1, file = "goog1.csv")
write.table(goog1, file = "goog1.tab")
...
plot(goog1[,2], xlab = "DAY", ylab = "STOCK VALUE ($)", col="blue")
#plot(goog1[,2], xlab = "DAY", ylab = "STOCK VALUE ($)", type = "l", col="blue")

# open value
lines(goog1[,5], type = "l", col="red")
