...
write.csv(aapl3, file = "aapl3.csv")
write.table(aapl3, file = "aapl3.tab")
...
#lines(aapl3[,5], col="red")
lines(aapl3[,5], type = "l", col="red")
#lines(aapl3[,2], type = "l", col="red")
#lines(aapl3[,3], type = "l", col="green")
