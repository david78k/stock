...
write.csv(aapl4, file = "aapl4.csv")
write.table(aapl4, file = "aapl4.tab")
...
#plot(as.numeric(aapl4[,2]), xlab = "DAY", ylab = "STOCK VALUE ($)", lty = 1, col="blue")
plot(as.numeric(aapl4[,2]), xlab = "DAY", ylab = "STOCK VALUE ($)", type = "l", col="blue")
#plot(aapl4[,2], xlab = "DAY", ylab = "STOCK VALUE ($)", type = "l", col="blue")

# close value
#lines(as.numeric(aapl4[,5]), col="red")
#lines(aapl4[,5], col="red")
lines(aapl4[,5], type = "l", col="red")
#lines(aapl4[,2], type = "l", col="red")
#lines(aapl4[,3], type = "l", col="green")
