...
#trainset <- window(AAPL, start = as.Date("1900-01-01"), end = as.Date("2013-04-01"))
trainsetraw <- window(AAPL, start = as.Date("1900-01-01"), end = as.Date("2013-04-01"))
print(ncol(trainsetraw)-1)
print(trainsetraw[,1:ncol(trainsetraw)-1])
trainset <- na.omit(trainsetraw[,1:ncol(trainsetraw)-1])
print(trainset)

#AAPL_Subset <- window(AAPL, start = as.Date("1900-01-01"), end = as.Date("2013-04-01"))
...
for (i in 1: rows) {
	...
	#diff = (abs ((pred - actual)/ actual))[1,]$AAPL.Close
