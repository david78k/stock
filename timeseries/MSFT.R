...
#trainset <- window(MSFT, start = as.Date("1900-01-01"), end = as.Date("2013-04-01"))
trainsetraw <- window(MSFT, start = as.Date("1900-01-01"), end = as.Date("2013-04-01"))
print(ncol(trainsetraw)-1)
print(trainsetraw[,1:ncol(trainsetraw)-1])
trainset <- na.omit(trainsetraw[,1:ncol(trainsetraw)-1])
print(trainset)

#MSFT_Subset <- window(MSFT, start = as.Date("1900-01-01"), end = as.Date("2013-04-01"))
...
testset <- window(MSFT, start = as.Date("2013-04-02"), end = as.Date("2014-04-01"))
...
for (i in 1: rows) {
	...
	#diff = (abs ((pred - actual)/ actual))[1,]$MSFT.Close
