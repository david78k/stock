...
aapldata <- read.csv("http://www.google.com/finance/historical?q=AAPL&startdate=Mar+1%2C+2008&enddate=Mar+1%2C+2012&output=csv ", sep=",", header=1)
...
write.csv(aapldata, file = "appl.csv")
write.table(aapldata, file = "appl.tab")
