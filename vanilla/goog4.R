...
write.csv(goog4, file = "goog4.csv")
write.table(goog4, file = "goog4.tab")
...
plot(as.numeric(goog4[,2]), xlab = "DAY", ylab = "STOCK VALUE ($)", lty = 1, col="blue")
#plot(goog4[,2], xlab = "DAY", ylab = "STOCK VALUE ($)", type = "l", col="blue")

# close value
#lines(as.numeric(goog4[,5]), col="red")
#lines(goog4[,5], col="red")
lines(goog4[,5], type = "l", col="red")
#lines(goog4[,2], type = "l", col="red")
#lines(goog4[,3], type = "l", col="green")
