...
# reverse data rows
aapl5 = data[nrow(data):1, ]

print(names(data))
print(names(data)[c(2,5)])
#print(aapl5[, c(2, 5)])
print(as.numeric(aapl5[, 2]))
#print(aapl5)

write.csv(aapl5, file = "aapl5.csv")
write.table(aapl5, file = "aapl5.tab")
...
#plot(aapl5[,2], xlab = "DAY", ylab = "STOCK VALUE ($)", type = "l", col="blue")
#plot(as.numeric(aapl5[,2]), xlab = "DAY", ylab = "STOCK VALUE ($)", type = "l", col="blue")

# close value
#lines(as.numeric(aapl5[,5]), col="red")
#lines(aapl5[,5], col="red")
lines(aapl5[,5], type = "l", col="red")
#lines(aapl5[,3], type = "l", col="green")
