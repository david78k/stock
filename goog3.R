...
write.csv(goog3, file = "goog3.csv")
write.table(goog3, file = "goog3.tab")
...
#plot(as.numeric(goog3[,2]), xlab = "DAY", ylab = "STOCK VALUE ($)", lty = 1, col="blue")
plot(goog3[,2], xlab = "DAY", ylab = "STOCK VALUE ($)", type = "l", col="blue")

# close value
#lines(as.numeric(goog3[,5]), col="red")
#lines(goog3[,5], col="red")
lines(goog3[,5], type = "l", col="red")
#lines(goog3[,2], type = "l", col="red")
#lines(goog3[,3], type = "l", col="green")
